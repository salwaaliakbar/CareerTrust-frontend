        ...
        <div className="flex flex-col md:flex-row items-center gap-8 relative z-10">
          ...
          <div className="relative group/avatar">
            ...
            <button
              ...
              className="absolute bottom-2 right-2 bg-linear-to-r from-blue-500 to-indigo-500 text-white p-3 rounded-full shadow-xl hover:shadow-2xl hover:scale-110 transition-all duration-300 border-2 border-white/30"
            ...
            {profileImage && (
              <button
                type="button"
                onClick={removeImage}
                className="absolute top-0 right-0 bg-linear-to-r from-rose-500 to-red-500 text-white p-2 rounded-full shadow-xl hover:scale-110 transition-all duration-200 border-2 border-white/30"
          ...
          <div className="flex flex-col gap-3">
            <button
              ...
              onClick={onSave}
              disabled={saving}
              className="group relative inline-flex items-center justify-center gap-2 bg-linear-to-r from-[#0C2B4E] to-[#1D546C] text-white px-8 py-3.5 rounded-xl shadow-xl hover:shadow-2xl hover:scale-105 transition-all duration-300 font-bold overflow-hidden"
            >
            ...
            <button
              type="button"
              onClick={onReset}
              className="inline-flex items-center justify-center gap-2 bg-white/10 backdrop-blur-sm border border-white/20 text-white px-6 py-2.5 rounded-xl hover:bg-white/20 hover:border-white/30 transition-all duration-200 font-semibold text-sm"
            >
              Reset All
            </button>
          </div>
