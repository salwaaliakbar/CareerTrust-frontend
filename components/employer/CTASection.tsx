...
export default function CTASection() {
  return (
    <section className="py-16 px-4 bg-[#1D546C]">
      <div className="max-w-4xl mx-auto text-[#F4F4F4] fade-in">
        <div className="flex flex-col items-center md:items-stretch md:flex-row md:justify-between gap-6">
          <div className="text-center md:text-left fade-in animation-delay-100">
          ...
          <div className="shrink-0 fade-in animation-delay-200">
            <Link
              ...
              className="inline-block bg-[#F4F4F4] text-[#1D546C] hover:bg-gray-100 px-6 py-3 rounded-full font-semibold shadow-lg transition-all duration-300 hover:scale-105 active:scale-95"
            >
              Explore Companies
            </Link>
          </div>
