...
export default function AdminDashboardLayout({
  ...
  const navigation = [
    ...
    {
      name: "Companies",
      href: "/admin/admindashboard/companies",
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path
            strokeLinecap="round"
    ...
    {
      name: "Self Exit Requests",
      href: "/admin/admindashboard/exit-requests",
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path
            strokeLinecap="round"
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-gray-50 via-blue-50/30 to-gray-50">
      {/* Sidebar */}
      <div
        className={`fixed inset-y-0 left-0 z-50 w-64 bg-linear-to-b from-[#0C2B4E] via-[#1A3D64] to-[#0C2B4E] backdrop-blur-xl border-r border-white/10 shadow-2xl transform transition-all duration-300 ease-in-out ${
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="p-4 border-t border-white/10 bg-white/5 backdrop-blur-sm">
            <div className="flex items-center px-4 py-3 bg-white/10 rounded-xl backdrop-blur-sm border border-white/10">
              <div className="shrink-0 w-10 h-10 bg-linear-to-br from-[#F97316] to-[#EA580C] rounded-full flex items-center justify-center text-white font-bold shadow-lg">
            ...
            <button
              ...
              className="mt-2 w-full flex items-center justify-center px-4 py-2 text-sm font-medium text-white bg-linear-to-r from-red-500 to-red-600 rounded-xl hover:from-red-600 hover:to-red-700 hover:shadow-lg transition-all duration-200 group"
            >
